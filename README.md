...
The theme comes with two default collections: `news` and `research`.
Items from the `news` collection are automatically displayed on the home page.
Items from the `research` collection are displayed on a responsive grid on research page.

<p align="center"><img src="https://raw.githubusercontent.com/alshedivat/al-folio/master/assets/img/research-screenshot.png" width=700></p>
